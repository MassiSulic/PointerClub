<nav x-data="{ open: false }" class="border-b mt-24 lg:mt-28 bg-white bg-opacity-15 lg:backdrop-blur fixed w-full">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 bg-white bg-opacity-80 backdrop-blur">
            <div class="px-4">
