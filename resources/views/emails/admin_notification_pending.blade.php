...
<head>
    ...
    <title>Nueva Inscripcion con Pago Pendiente</title>
    <style>
        body {
...
<body>
    ...
    <h1>Se ha realizado una Inscripción</h1>
    ...
    <p style="color: red; font-weight: bold; text-align: center;">El usuario debe pagar presencialmente el día de la competencia.</p>

    <div class="footer">
        <p>Por favor, revisa la inscripción.</p>
    </div>
