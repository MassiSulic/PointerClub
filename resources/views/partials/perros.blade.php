    ...
    <table class="table-auto w-full border-collapse border border-gray-300">
        <thead>
            <tr class="bg-gray-100">
                ...
                <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-700">Fecha de nacimiento</th>
                ...
                <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-700">Microchip</th>
                <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-700">Libro de origenes</th>
                <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-700">Cartilla de trabajo</th>
        ...
        <tbody class="divide-y divide-gray-200">
            @foreach($perros as $perro)
                <tr>
                    ...
                    <td class="border border-gray-300 px-4 py-2 text-sm text-gray-800">{{ $perro->fecha_nacimiento }}</td>
                    ...
                    <td class="border border-gray-300 px-4 py-2 text-sm text-gray-800">{{ $perro->microchip }}</td>
                    <td class="border border-gray-300 px-4 py-2 text-sm text-gray-800">{{ $perro->libro_de_origenes }}</td>
                    <td class="border border-gray-300 px-4 py-2 text-sm text-gray-800">{{ $perro->cartilla_de_trabajo }}</td>
